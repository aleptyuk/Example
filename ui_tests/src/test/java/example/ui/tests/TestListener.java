...
public class TestListener extends TestListenerAdapter {
    ...
    public void onTestFailure(ITestResult result) {
        ...
        try {
            ...
            screenshot = DriverManager.takeScreenshot(BaseUiTest.getDriverThread());
        } catch (Exception e) {
            log.info("TestListener onTestFailure method: " + e);
        }
    ...
    public void onTestSkipped(ITestResult result) {
        ...
        try {
            ...
            log.info("TestListener onTestSkipped method: " + e);
        }
        logTestResult(result, null);
    ...
    public void printTestResult(ITestResult testResult, String id) {
        ...
        log.info(MSG_LINE);
        log.info("UI: Test case #" + id + "  '" + testResult.getName() + "' is " + testStatus);
